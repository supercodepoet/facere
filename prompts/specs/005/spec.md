...
Again, use the *.pen files as the source of truth and visual reference on the UI/UX and business flow of this feature. Ask for anything that is unclear or make recommendations for this feature. For any decisions we make, make sure to flow those back into the *.pen files.